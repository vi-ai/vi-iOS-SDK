//
//  InterstitialMediationControllerSwift.swift
//  VIFBSample
//
...
class InterstitialMediationControllerSwift: UIViewController {

    fileprivate lazy var ad:VIInterstitialAd? = {
		
		// FIXME: user your placementId.
        let placement = VIPlacement("plthod5n2f39ced7j6t", options: nil)
...
extension InterstitialMediationControllerSwift : VIAdDelegate
{
